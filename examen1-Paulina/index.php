...
<body>
    ...
    <div class="contenedor1"> 
        <button type="button" class="b1" id="c1" onclick="mostrarFoto10()">Mostrar foto</button>
        <button type="button" class="b1" id="c2" onclick="ocultarFoto10()">Ocultar foto</button>
    ...
    <div class="contenedor2">
        ...
        <form>
            ...
            <br><br>
            <button type="button" class="b1" onclick="validarTelefono10()">Validar</button>
        </form>
        <br>
